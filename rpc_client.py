...
def cur_ping_status():
   threading.Timer(6.0, cur_ping_status).start()
	 ...
	 subprocess.Popen(['./net_latency_emu.sh'])
...
try:
    ...
    print proxy.set_left_delay(get_current_delay(0))
    print proxy.set_right_delay(get_current_delay(1))
